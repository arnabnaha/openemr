...
function documents_report( $pid, $encounter, $cols, $id) {
	...
	if ($row) {
		...
		echo ("<iframe src=\"../../forms/documents/scanned/${pid}/${doc_image}\"width=\"95%\"height=\"100%\"></iframe>");
		//echo ("<tr><td><iframe src=\"../../forms/documents/scanned/${pid}/${doc_image}\"width=\"90%\"height=\"100%\"></iframe></td></tr>");
		// == 'application/pdf'
